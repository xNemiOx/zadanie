...
//                                         value={phone}
//                                         onChange={(e) => setPhone(e.target.value)}
//                                         className='text-black py-3 px-2 font-semibold rounded-md h-14 transition w-72 bg-white z-10 placeholder:text-background'
//                                     />
//                                 ) : (
//                                     <label className='text-black py-3 px-2 font-semibold rounded-md h-14 transition  z-10'>
//                                         {phone || 'Телефон'}
...
//                                             className='text-black py-3 px-2 font-semibold rounded-md h-14 transition w-72 bg-white z-10 placeholder:text-background'
//                                         />
//                                         <button type="button" onClick={() => setShowOldPassword(!showOldPassword)} className="absolute inset-y-0 right-1 pr-3 flex items-center text-black">
...
//                                             className='text-black py-3 px-2 font-semibold rounded-md h-14 transition w-72 bg-white z-10 placeholder:text-background'
//                                         />
//                                         <button type="button" onClick={() => setShowNewPassword(!showNewPassword)} className="absolute inset-y-0 right-1 pr-3 flex items-center text-black">
...
//                                         Обновить
//                                     </button>
//                                     <button type="button" onClick={() => setIsEditing(false)} className="text-black bg-white rounded-3xl w-52 py-3">
//                                         Отмена
//                                     </button>
//                                 </>
//                             ) : (
